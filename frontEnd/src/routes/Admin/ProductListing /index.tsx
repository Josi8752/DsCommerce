...
import imgIconEdit from '../../../assets/edit.svg';
...

                        {
                            products.map(product => (
                                <tr key={product.id}>
                                    ...
                                    <td><img onClick={() => handleUpdateClick(product.id)} className="dsc-product-listing-btn" src={imgIconEdit} alt="Editar" /></td>
                                    <td><img onClick={() => handleDeleteClick(product.id)} className="dsc-product-listing-btn" src={imgIconDelete} alt="Deletar" /></td>
                                </tr>
                            ))
                        }
